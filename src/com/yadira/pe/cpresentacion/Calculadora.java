...
public void numeroOperado(String sentencia, String simbolo) {
    ...
    float primerNumero = Float.parseFloat(numeros[0].trim());
    float segundoNumero = Float.parseFloat(numeros[1].trim());
    ...
    if (simbolo.equals("+")) {
        ...
        if (segundoNumero != 0) {
            ...
            this.tfresultado.setText("Error: Division by 0");  // Display error message
            return;  // Exit early to avoid setting an incorrect result
        }
    }
